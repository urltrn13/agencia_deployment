...
--
-- Host: localhost:8889
-- Generation Time: May 28, 2020 at 04:15 PM
...
(1, 'Julian', 'julian@sosa.com', 'Excelentes vacaciones, gracias!!!'),
(2, 'Julian', 'julian@sosa.com', 'Excelentes vacaciones, gracias!!!'),
(3, 'Julian', 'julian@sosa.com', 'Excelentes vacaciones, gracias!'),
(4, 'Julian S', 'julian@sosa.com', 'Quisque feugiat diam nec est consectetur, at sollicitudin purus consectetur. Nam malesuada, nibh quis facilisis vehicula, massa ante efficitur quam, eu sagittis nulla nulla quis tortor. In consectetur vehicula congue. Nulla accumsan lectus lectus, ut congue orci faucibus fermentum. '),
(5, 'Un nuevo cliente', 'nuevo@correo.com', 'Probando Async / Await'),
(6, 'Mr Julian', 'mr@julian.co', 'Testing abslfkjad f'),
(7, 'La Peste', 'la@peste.com', 'lorem skskd sdlfkadf');
